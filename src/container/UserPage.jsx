...
import {AsyncSetUser ,AsyncSetFollowersFollowing,removingError} from '../store/action';
 ...
 class UserPage extends Component {
    ...
    render() {
        ...
        return (
                ...
                <Card.Content>
                <Link to={`/${userData.login}/followers`} onClick={()=>this.onClick('Followers')}  > 
                    <Icon name='user'  />{`Followers ${userData.followers}`}  <br/></Link>
                <Link to={`/${userData.login}/following`} onClick={()=>this.onClick('Following')} >
                     <Icon name='user'  />{ `Following ${userData.following} `}  <br/></Link>
                <Link to={`/${userData.login}/repository`} onClick={()=>this.onClick('Repository')} >
                     <Icon name='folder'  />{ `Repository ${userData.public_repos} `}  <br/></Link>
                ...
                <Card.Content >
                    <Icon name='user' />{userData.company}  <br/>
